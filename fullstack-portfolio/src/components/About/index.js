                ...
                <div className="row justify-content-center">
                    <div className="col-xxl-12">
                        ...
                        <div className="row">
                                ...
                                <img src={mainPhoto} alt="Julius Maxwell" className="img-circle img-fluid" />
                                </div>
                                <div className="col-xxl-9 col-xl-8">
                                <h1>{greeting} My name is Julius,I'm a Web Designer &amp; Fullstack Developer out of Orlando, FL.</h1>
